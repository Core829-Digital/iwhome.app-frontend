...
export default function Privacy() {
  return (
    <div className="pt-24">
      {/* Hero */}
      <section className="py-16 bg-[#2D3B35]">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none text-[#2D3B35]/80">
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Titolare del Trattamento dei Dati</h2>
            <p>IwHome</p>
            <p><strong>Indirizzo email del Titolare:</strong> info@iwhome.it</p>

            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Tipologie di Dati raccolti</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">
              Modalità e luogo del trattamento dei Dati raccolti
            </h2>

            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Modalità di trattamento</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Luogo</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Periodo di conservazione</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Google Fonts (Google LLC)</h4>
            <p>
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Widget Google Maps (Google LLC)</h4>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Statistica</h3>
            <p>
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Google Analytics (Google LLC)</h4>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Cookie Policy</h2>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Base giuridica del trattamento</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Diritti dell'Utente</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Dettagli sul diritto di opposizione</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Come esercitare i diritti</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Difesa in giudizio</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Informative specifiche</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Log di sistema e manutenzione</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Dati Personali (o Dati)</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Dati di Utilizzo</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Utente</h3>
            <p>
              L'individuo che utilizza questa Applicazione che, salvo ove diversamente specificato, coincide con 
              l'Interessato.
            </p>

            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Interessato</h3>
            <p>La persona fisica cui si riferiscono i Dati Personali.</p>

            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Questa Applicazione</h3>
            <p>
              Lo strumento hardware o software mediante il quale sono raccolti e trattati i Dati Personali degli 
              Utenti.
            </p>

            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Servizio</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Unione Europea (o UE)</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Cookie</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Strumento di Tracciamento</h3>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Riferimenti legali</h2>
            <p>
              Ove non diversamente specificato, questa informativa privacy riguarda esclusivamente questa 
              Applicazione.
            </p>

            <p className="text-sm text-[#2D3B35]/60 mt-8">Ultima modifica: 23/07/25</p>
          </div>
        </div>
      </section>
    </div>
