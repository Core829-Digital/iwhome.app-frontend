...
function CollaboratorDetailModal({ id, onClose, onGenerateAccess }) {
    ...
    return (
        <Dialog open={!!id} onOpenChange={onClose}>
            <DialogContent className="bg-[#343a40] border-[#495057] text-[#f8f9fa] max-w-2xl max-h-[90vh] overflow-y-auto" style={{ maxWidth: 'min(calc(100vw - var(--sidebar-w, 0px) - 3rem), 30rem)' }}>
                <DialogHeader>
