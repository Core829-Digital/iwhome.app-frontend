      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none text-[#2D3B35]/80">
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">1. Accettazione dei Termini</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">2. Descrizione dei Servizi</h2>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">3. Preventivi Online</h2>
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">3.1 Natura Indicativa</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">3.2 Preventivo Definitivo</h3>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">4. Prenotazione Appuntamenti</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">5. Proprietà Intellettuale</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">6. Limitazione di Responsabilità</h2>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">7. Obblighi dell'Utente</h2>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">8. Garanzie sui Lavori</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">9. Risoluzione delle Controversie</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">10. Modifiche ai Termini</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">11. Legge Applicabile</h2>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">12. Contatti</h2>
            <p>
