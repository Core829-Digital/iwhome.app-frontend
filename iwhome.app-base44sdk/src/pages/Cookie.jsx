      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <div className="prose prose-lg max-w-none text-[#2D3B35]/80">
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Cookie</h2>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Esperienza</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Interazione con social network e piattaforme esterne</h3>
            <p>
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Pulsante Mi Piace e widget sociali di Facebook (Meta Platforms, Inc.)</h4>
            <p>
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Pulsante e widget sociali di Linkedin (LinkedIn Corporation)</h4>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Visualizzazione di contenuti da piattaforme esterne</h3>
            <p>
            ...
            <h3 className="text-xl font-medium text-[#2D3B35] mt-6 mb-3">Misurazione</h3>
            <p>
            ...
            <h4 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Statistica</h4>
            <p>
            ...
            <h2 className="text-2xl font-medium text-[#2D3B35] mt-8 mb-4">Definizioni e riferimenti legali</h2>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Responsabile del Trattamento (o Responsabile)</h3>
            <p>
            ...
            <h3 className="text-lg font-medium text-[#2D3B35] mt-4 mb-2">Titolare del Trattamento (o Titolare)</h3>
            <p>
